...
const parseApiSpecs = (apiSpecs: ApiSpec): Spec => {
  return new Spec(
    apiSpecs.screen,
    apiSpecs.resolution,
    apiSpecs.processor,
...
const parseApiColorOptions = (apiColorOptions: ApiColorOption[]): ColorOption[] => {
...
const parseApiStorageOptions = (apiStorageOptions: ApiStorageOption[]): StorageOption[] => {
